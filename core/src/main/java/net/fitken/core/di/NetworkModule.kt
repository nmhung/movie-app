...
import net.fitken.core.data.network.interceptor.BasicAuthInterceptor
import net.fitken.core.data.network.interceptor.ConnectivityInterceptor
import net.fitken.core.data.network.service.MapService
import net.fitken.core.data.network.service.MovieService
import net.fitken.core.data.repository.MapRepositoryImpl
import net.fitken.core.data.repository.MovieRepositoryImpl
